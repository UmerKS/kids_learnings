...
class AlphabetsOScreen extends StatefulWidget {
  const AlphabetsOScreen({Key? key}) : super(key: key);

  @override
  _AlphabetsOScreenState createState() => _AlphabetsOScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AlphabetsOScreenState extends State<AlphabetsOScreen> {
  String get word_1 => "Orange";

  String get word_2 => "Onion";

  String get word_3 => "Octopus";

  String get word_4 => "Ostrich";

  String get letterWord => "O o";
  ...
  Future _speak(String text) async {
    await _flutterTts.speak("O for " +text);
  }
