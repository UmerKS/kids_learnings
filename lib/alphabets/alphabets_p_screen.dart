...
class AlphabetsPScreen extends StatefulWidget {
  const AlphabetsPScreen({Key? key}) : super(key: key);

  @override
  _AlphabetsPScreenState createState() => _AlphabetsPScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AlphabetsPScreenState extends State<AlphabetsPScreen> {
  ...
  Future _speak(String text) async {
    await _flutterTts.speak("P for " +text);
  }
