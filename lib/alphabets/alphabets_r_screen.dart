...
import './alphabets_q_screen.dart';
import './alphabets_s_screen.dart';

class AlphabetsRScreen extends StatefulWidget {
  const AlphabetsRScreen({Key? key}) : super(key: key);

  @override
  _AlphabetsRScreenState createState() => _AlphabetsRScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AlphabetsRScreenState extends State<AlphabetsRScreen> {
  String get word_1 => "Rainbow";

  String get word_2 => "Rat";

  String get word_3 => "Rabbit";

  String get word_4 => "Rain";

  String get letterWord => "R r";
  ...
  Future _speak(String text) async {
    await _flutterTts.speak("R for " +text);
  }
