...
class AlphabetsSScreen extends StatefulWidget {
  const AlphabetsSScreen({Key? key}) : super(key: key);

  @override
  _AlphabetsSScreenState createState() => _AlphabetsSScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AlphabetsSScreenState extends State<AlphabetsSScreen> {
  String get word_1 => "Sun";

  String get word_2 => "Snowman";

  String get word_3 => "Snake";

  String get word_4 => "Spider";

  String get letterWord => "S s";
  ...
  Future _speak(String text) async {
    await _flutterTts.speak("S for " +text);
  }
