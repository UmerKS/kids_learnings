...
class AlphabetsVScreen extends StatefulWidget {
  const AlphabetsVScreen({Key? key}) : super(key: key);

  @override
  _AlphabetsVScreenState createState() => _AlphabetsVScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AlphabetsVScreenState extends State<AlphabetsVScreen> {
  String get word_1 => "Violin";

  String get word_2 => "Van";

  String get word_3 => "Vegetable";

  String get word_4 => "Vulture";

  String get letterWord => "V v";
  ...
  Future _speak(String text) async {
    await _flutterTts.speak("V for " +text);
  }
