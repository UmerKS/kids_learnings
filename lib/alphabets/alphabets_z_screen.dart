...
class AlphabetsZScreen extends StatefulWidget {
  const AlphabetsZScreen({Key? key}) : super(key: key);

  @override
  _AlphabetsZScreenState createState() => _AlphabetsZScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AlphabetsZScreenState extends State<AlphabetsZScreen> {
  String get word_1 => "Zebra";

  String get word_2 => "Zoo";

  String get word_3 => "Zero";

  String get word_4 => "Zip";

  String get letterWord => "Z z";
  ...
  Future _speak(String text) async {
    await _flutterTts.speak("Z for " +text);
  }
